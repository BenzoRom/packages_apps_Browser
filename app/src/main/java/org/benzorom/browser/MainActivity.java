...
import org.benzorom.browser.favorite.FavoriteActivity;
import org.benzorom.browser.favorite.FavoriteProvider;
import org.benzorom.browser.history.HistoryActivity;
import org.benzorom.browser.suggestions.SuggestionsAdapter;
...
import org.benzorom.browser.webview.WebViewExtActivity;
...
public class MainActivity extends WebViewExtActivity implements
    ...
    private static final String PROVIDER = "org.benzorom.browser.fileprovider";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            ...
            adblockEnabled = savedInstanceState.getBoolean(IntentUtils.EXTRA_ADBLOCK_ENABLED, true);
    ...
    public void onSaveInstanceState(Bundle outState) {
        ...
        outState.putBoolean(IntentUtils.EXTRA_ADBLOCK_ENABLED, mWebView.isAdblockEnabled());
    ...
    private void addShortcut() {
        ...
        Bitmap icon = mUrlIcon == null ?
                BitmapFactory.decodeResource(getResources(), R.drawable.ic_launcher) : mUrlIcon;
